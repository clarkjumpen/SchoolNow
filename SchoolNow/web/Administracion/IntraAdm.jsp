...
<html>
    ...
    <body>
        ...
        <div class="container">
            <header>
                <a href="#"><img src="" alt="Insertar logotipo aquí" name="Insert_logo" width="180" height="90" id="Insert_logo" style="background: #C6D580; display:block;" /></a>
            </header>
            <div class="sidebar1">
                <nav>
                    <ul>
                        <li>
                            ...
                            <form action="../index.jsp">
                                ...
                                Usuario:<input type=text name="user" value="<%=user%>" disabled>
                                <input type="submit"  value="Salir">
                            </form>
                            <br>


                        <li><a href="#" onclick="cambiar('doc');
                            return false;">Administracion Docentes</a></li>
                        <div class="sidebar1" id="doc" style="display: none;">
                            <li><a href="Docentes/AgregarDocente.jsp" target="Insert">Agregar Docente</a></li>
                            <li><a href="Docentes/ModificarDocente.jsp" target="Insert">Modificar Docente</a></li>
                            <li><a href="Docentes/ListarDocente.jsp" target="Insert">Listar Docentes</a></li>
                        </div>
                        <li><a href="#" onclick="cambiar('als');
                            return false;">Administracion Alumnos</a></li>
                        <div class="sidebar1" id="als" style="display: none;">
                            <li><a href="AdmDoc.jsp" target="Insert">Agregar Alumno</a></li>
                            <li><a href="AdmDoc.jsp" target="Insert">Modificar Alumno</a></li>
                            <li><a href="AdmDoc.jsp" target="Insert">Listar Alumnos</a></li>
                        </div>
                        <li><a href="#" onclick="cambiar('cur');
                            return false;">Administracion Cursos</a></li>
                        <div class="sidebar1" id="cur" style="display: none;">
                            <li><a href="AdmDoc.jsp" target="Insert">Agregar Curso</a></li>
                            <li><a href="AdmDoc.jsp" target="Insert">Modificar Curso</a></li>
                            <li><a href="AdmDoc.jsp" target="Insert">Listar Cursos</a></li>
                        </div>
                        <li><a href="#" onclick="cambiar('asg');
                            return false;">Administracion Asignaturas</a></li>
                        <div class="sidebar1" id="asg" style="display: none;">
                            <li><a href="AdmDoc.jsp" target="Insert">Agregar Asignatura</a></li>
                            <li><a href="AdmDoc.jsp" target="Insert">Modificar Asignatura</a></li>
                            <li><a href="AdmDoc.jsp" target="Insert">Listar Asignaturas</a></li>
                        </div>
                        <li><a href="ayuda.jsp" target="_blank">Ayuda</a></li>
                    </ul>
                </nav>
                <aside>
            ...
            <article class="content">
                ...
                <section>
                    ...
                    <p>En caso de error, contactar con el administrador</p>
                </section>
                <section>
                    <h2>Intranet</h2>
                    <iframe name="Insert" frameborder="NO" height="700" wimarginheight="0" marginwidth="0" scrolling="YES" src="IntraAdmInfo.jsp" style="border-color: black; border-style: solid; border-width: 5;" width="600"></iframe>
