...
<div class="container">
  ...
  <article class="content">
    ...
    <section>
        <h2><%=user%></h2>
      <p>Aqui podras revisar tus notas, enviar solicitudes y mas , si acaso surge algun problema.</p>
    </section>
    <section>
      <h2>&nbsp;</h2>
    </section>
    <section>
      ...
      <p>"Recuerda cambiar tu contraseña con frecuencia"</p>
  ...
  <footer>
    <p>Este footercontiene la declaración position:relative; para dar a Internet Explorer 6 hasLayout para footer y provocar que se borre correctamente. Si no es necesario proporcionar compatibilidad con IE6, puede quitarlo.</p>
    <address>
