    ...
    <body>
        ...
        <div class="container">
                ...
                <nav>
                    <ul>
                        <li>
                            ...
                            <b>Iniciar Sesion</b>
                            <form action="Administracion/IntraAdm.jsp" method="post">
                                Usuario:<input type=text name="user">
                                Contraseña:<input type=password name="pass">
                                <input type=submit  value="Ingresar"><br>
                                <input type="radio" name="identidad" value="Alumno" checked >Alumno
                                <input type="radio" name="identidad" value="Docente">Docente
                            </form>
                            <br>
            ...
            <article class="content">
                <h1>School Now</h1>
                <section>
                    <h2>Bienvenido a la intranet de la escuela</h2>
