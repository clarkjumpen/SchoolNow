 ...
 * @author Clark
 */
public class AdmCurso extends javax.swing.JDialog {

    /**
     * Creates new form AdmDocentes
     */
    public AdmCurso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void inicializarComponentes() {
        ...
        ArrayList<Docente> docentes = negD.getDocentes();
        for (int i = 0; i < docentes.size(); i++) {
            
            this.cmbProfesorJefe.addItem(docentes.get(i).getNombre());
        }
    ...
    private void initComponents() {
        ...
        cmbProfesorJefe = new javax.swing.JComboBox();
        ...
        lblTitulo.setText("Administracion Cursos");

        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Datos Curso"));
        ...
        jPanel14.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Profesor Jefe"));

        cmbProfesorJefe.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccionar..." }));
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cmbProfesorJefe, 0, 188, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cmbProfesorJefe, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        btnListarTodas.setText("Listar Todos");
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnLimpiar, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public boolean comprobarCampos() {
        ...
        if (this.txtNombre.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Porfavor, ingrese el nombre del Curso", "Faltan datos", JOptionPane.WARNING_MESSAGE);
            this.txtNombre.requestFocus();
            return true;
        }
        if (this.cmbProfesorJefe.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(this, "Porfavor, Elija el profesor En jefe", "Faltan datos", JOptionPane.WARNING_MESSAGE);
            this.cmbProfesorJefe.requestFocus();
            return true;
        }
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        NegocioCurso negd = new NegocioCurso();
        if (comprobarCampos() == true) {
            return;
        } else {
            if (negd.existeCurso(this.txtNombre.getText()) == true) {
                JOptionPane.showMessageDialog(this, "El Curso que esta intentando ingresar, ya se encuentra registrado", "Error de duplicacion", JOptionPane.WARNING_MESSAGE);
            } else {
                int opcion = 0;
                opcion = JOptionPane.showConfirmDialog(this,
                        "Desea Ingresar el Curso " + this.txtNombre.getText() + " ?",
                        "Confirmar",
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    ...
                    d.setProfesorJefe((String) this.cmbProfesorJefe.getSelectedItem());
                    negd.ingresarCurso(d);
                    JOptionPane.showMessageDialog(this, "Curso " + d.getNombre() + " Ingresado con Exito!", "Suceso", JOptionPane.INFORMATION_MESSAGE);
                    limpiarCampos();
                }
            }
        }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        int opcion = 0;
        opcion = JOptionPane.showConfirmDialog(this,
                "Guardar cambios en Curso " + this.txtNombre.getText() + " ?",
                "Confirmar",
                JOptionPane.YES_NO_OPTION,
                JOptionPane.QUESTION_MESSAGE);
        if (opcion == JOptionPane.YES_OPTION) {
            ...
            negD.modificarCurso(d, this.txtBuscarRut.getText().trim());
            JOptionPane.showMessageDialog(this, "Curso " + d.getNombre() + " Modificado con Exito!", "Suceso", JOptionPane.INFORMATION_MESSAGE);
            limpiarCampos();
        }
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        if (this.tblResultados.getSelectedRow() == -1) {
            ...
            if (rut == null) {
                ...
                if (negD.buscarCurso(this.txtBuscarRut.getText()).getNombre().equals(rut)) {
                    d = negD.buscarCurso(this.txtBuscarRut.getText());
                    LlenarFormulario(d);
                    
                }
                if (this.txtBuscarRut.getText().trim().isEmpty()) {
                    
                    d = negD.buscarCurso((String) this.tblResultados.getValueAt(x, 0));
                    LlenarFormulario(d);
                }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        NegocioCurso negD = new NegocioCurso();
        Curso d = negD.buscarCurso(this.txtBuscarRut.getText());
        
        if (negD.existeCurso(this.txtBuscarRut.getText().trim()) == false) {
            JOptionPane.showMessageDialog(this, "No se encontro el Curso!", "No encontrado", JOptionPane.WARNING_MESSAGE);
    ...
    private void LlenarFormulario(Curso d) {
        
        this.txtNombre.setText(d.getNombre());
        this.cmbProfesorJefe.setSelectedItem(d.getProfesorJefe());
    ...
    private void limpiarCampos() {
        ...
        this.cmbProfesorJefe.setSelectedIndex(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmCurso.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AdmCurso dialog = new AdmCurso(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox cmbProfesorJefe;
