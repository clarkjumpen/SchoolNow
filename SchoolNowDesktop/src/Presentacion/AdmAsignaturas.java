...
public class AdmAsignaturas extends javax.swing.JDialog {
    ...
    public void inicializarComponentes() {
        ...
        for (int i = 0; i < docentes.size(); i++) {
            this.cmbProfesor.addItem(docentes.get(i).getNombre() + " " + docentes.get(i).getApellido());
        }
        resetearTabla();
    ...
    private void initComponents() {
        ...
        jPanel14.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Docente"));

        cmbProfesor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccionar..." }));
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cmbProfesor, 0, 188, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public boolean comprobarCampos() {
        ...
        if (this.cmbProfesor.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(this, "Porfavor, Elija el profesor De esta asignatura", "Faltan datos", JOptionPane.WARNING_MESSAGE);
            this.cmbProfesor.requestFocus();
            return true;
        }
        return false;
    }
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (comprobarCampos() == true) {
            ...
            if (negR.existeRamo(this.txtNombre.getText().trim(), (String) this.cmbProfesor.getSelectedItem()) == true) {
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    ...
                    ArrayList<Docente> docentes = new NegocioDocente().getDocentes();
                    String nombre;
                    for (int i = 0; i < docentes.size(); i++) {
                        nombre = docentes.get(i).getNombre() + " " + docentes.get(i).getApellido();
                        if (nombre.equals((String) this.cmbProfesor.getSelectedItem())) {
                            System.out.println(nombre);
                            System.out.println(this.cmbProfesor.getSelectedItem());
                            Doc = docentes.get(i);
                        }
                    }
                    negd.ingresarAsignatura(d, Doc);
    ...
    private void btnListarTodasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarTodasActionPerformed
        NegocioRamo negR = new NegocioRamo();
        ArrayList<Ramo> ramos = negR.getRamos();
        
        DefaultTableModel modelito = new DefaultTableModel();
        modelito.addColumn("Asignatura");
        modelito.addColumn("Docente");
        
        Object[] datos = new Object[2];
        for (int i = 0; i < ramos.size(); i++) {
            datos[0] = new NegocioAsignatura().buscarAsignatura(ramos.get(i).getAsignatura()).getNombre();
            Docente d =new NegocioDocente().buscarDocente(ramos.get(i).getDocente());
            datos[1] =d.getNombre()+" "+d.getApellido();
    ...
    private void limpiarCampos() {
        ...
        this.cmbProfesor.setSelectedIndex(0);
